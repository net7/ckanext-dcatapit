...
class ThemeToSubtheme(DeclarativeBase, DomainObject):
    ...
    subtheme = orm.relationship('Subtheme', back_populates='theme_associations')
...
class Subtheme(DeclarativeBase, DomainObject):
    ...
    theme_associations = orm.relationship('ThemeToSubtheme', back_populates='subtheme')
    themes = orm.relationship(Tag,
                            secondary=ThemeToSubtheme.__table__,
                            viewonly=True)
